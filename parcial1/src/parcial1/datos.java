...
public class datos {
	...
	private float descclientefrecuente; //ingrese% por descuento de cliente frecuente 
	...
	public float getDescclientefrecuente() {
		return descclientefrecuente;
	}
	public void setDescclientefrecuente(float descclientefrecuente) {
		this.descclientefrecuente = descclientefrecuente;
	}
